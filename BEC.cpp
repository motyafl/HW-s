...
int main() {
    ...
    std::cout << "Вызов методов через указатели на методы класса" << std::endl;
    ...
    std::cout << "Вывод информации через дружественный класс ShapePrinter" << std::endl;
    ...
    std::cout << "Демонстрация работы функции callAreaViaPointer" << std::endl;
